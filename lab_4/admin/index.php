    ...
    <div class="row flex-nowrap">
      <div class="col-auto col-md-3 col-lg-2 bg-secondary text-white min-vh-100 p-3">
        ...
        <div class="d-grid gap-2">
            ...
            <a href="#" class="btn btn-info text-white"><i class="fa-solid fa-eye"></i> View Products</a>
            ...
            <a href="#" class="btn btn-info text-white"><i class="fa-solid fa-shopping-cart"></i> All Orders</a>
